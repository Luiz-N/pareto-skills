...
export default Ember.Component.extend({
  ...
  colors: ['rgba(77,175,74,.5)','rgba(77,175,74,1.0)', 'rgba(231,138,195,.5)','rgba(231,138,195,.8)', 'rgba(166,216,84,.5)','rgba(166,216,84,.8)', 'rgba(64,64,64,.5)','rgba(64,64,64,.8)', 'black'],
